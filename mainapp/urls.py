...
urlpatterns = [
    ...
    path('crm_orders/', views.crm_orders),
    path('crm_orders_stats/', views.crm_orders_stats),
    path('crm_products/', views.crm_products),
    path('crm_add_img/', views.crm_add_img),
    path('crm_del_img/', views.crm_del_img),
    path('crm_product_save/', views.crm_product),
    path('get_data1/', views.get_data1),
    path('get_data2/', views.GetData2.as_view()),
    path('get_pag_data/', views.get_pag_data),
